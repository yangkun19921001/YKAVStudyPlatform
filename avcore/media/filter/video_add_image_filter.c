//
// Created by 阳坤 on 2021/8/30.
//使用FFmpeg的AVfilter实现了视频的水印叠加功能。
//
...
const char *filter_descr = "movie=/Users/devyk/Data/Project/sample/github_code/YKAVStudyPlatform/temp/m_c1.png[wm];[in][wm]overlay=5:5[out]";
...
int main(int argc, char *argv[]) {
    ...
    if ((ret = open_input_file("/Users/devyk/Data/Project/sample/github_code/YKAVStudyPlatform/temp/noBFrame.mp4")) < 0)
        goto end;
    if ((ret = init_filters(filter_descr)) < 0)
        goto end;

#if ENABLE_YUVFILE
    FILE *fp_yuv = fopen("/Users/devyk/Data/Project/sample/github_code/YKAVStudyPlatform/temp/filter.yuv", "wb+");
#endif
#if ENABLE_SDL
    SDL_Surface *screen;
    SDL_Overlay *bmp;
